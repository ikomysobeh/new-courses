...
class ImportPostLikes extends LegacyImportCommand
{
    protected $signature = 'legacy:import-post-likes';

    protected $description = 'Import post_likes - identical schema, remaps podcast_post_id/user_id.';
    ...
    protected function mapRow(array $old): ?array
    {
        ...
        if ($newPostId === null || $newUserId === null) {
            $this->error("Unresolved mapping for post_like legacy_id={$old['id']} (podcast_post_id={$old['podcast_post_id']}, user_id={$old['user_id']})");
