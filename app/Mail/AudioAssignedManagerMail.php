...
class AudioAssignedManagerMail extends Mailable
{
    use Queueable, SerializesModels;

    public function __construct(
        public readonly User $manager,
        public readonly Collection $teamMembers,
    ...
    {
        return new Envelope(
            subject: 'Employee Audio Assignment Notification',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.audio.assigned-manager',
            with: [
